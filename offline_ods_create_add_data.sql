...
-- SELECT * FROM ods_cart_info_inc WHERE dt = '2025-09-15' LIMIT 10;
...
-- SELECT * FROM ods_comment_info_inc WHERE dt = '2025-09-15' LIMIT 10;
...
-- SELECT * FROM ods_coupon_use_inc WHERE dt = '2025-09-15' LIMIT 10;
...
(
    ...
    TBLPROPERTIES ('compression.codec'='org.apache.hadoop.io.compress.GzipCodec');
-- MSCK REPAIR TABLE ods_favor_info_inc;
-- SELECT * FROM ods_favor_info_inc WHERE dt = '2025-09-15' LIMIT 10;
...
-- SELECT * FROM ods_order_detail_inc WHERE dt = '2025-09-15' LIMIT 10;
...
-- SELECT * FROM ods_order_detail_activity_inc WHERE dt = '2025-09-15' LIMIT 10;
...
-- SELECT * FROM ods_order_detail_coupon_inc WHERE dt = '2025-09-15' LIMIT 10;
...
-- SELECT * FROM ods_order_info_inc WHERE dt = '2025-09-15' LIMIT 10;
...
-- SELECT * FROM ods_order_refund_info_inc WHERE dt = '2025-09-15' LIMIT 10;
...
-- SELECT * FROM ods_order_status_log_inc WHERE dt = '2025-09-15' LIMIT 10;
...
-- SELECT * FROM ods_payment_info_inc WHERE dt = '2025-09-15' LIMIT 10;
...
-- SELECT * FROM ods_refund_payment_inc WHERE dt = '2025-09-15' LIMIT 10;
...
SELECT * FROM ods_user_info_inc WHERE dt = '2025-09-15' LIMIT 10;



MSCK REPAIR TABLE realtime_v1_hive.ods_activity_info_full;
-- 在 Beeline / Hue 里执行一次即可
USE realtime_v1_hive;
MSCK REPAIR TABLE ods_activity_rule_full;
MSCK REPAIR TABLE ods_base_category1_full;
MSCK REPAIR TABLE ods_base_category2_full;
MSCK REPAIR TABLE ods_base_category3_full;
MSCK REPAIR TABLE ods_base_dic_full;
MSCK REPAIR TABLE ods_base_province_full;
MSCK REPAIR TABLE ods_base_region_full;
MSCK REPAIR TABLE ods_base_trademark_full;
MSCK REPAIR TABLE ods_cart_info_full;
MSCK REPAIR TABLE ods_coupon_info_full;
MSCK REPAIR TABLE ods_sku_attr_value_full;
MSCK REPAIR TABLE ods_sku_info_full;
MSCK REPAIR TABLE ods_sku_sale_attr_value_full;
MSCK REPAIR TABLE ods_spu_info_full;
MSCK REPAIR TABLE ods_promotion_pos_full;
MSCK REPAIR TABLE ods_promotion_refer_full;